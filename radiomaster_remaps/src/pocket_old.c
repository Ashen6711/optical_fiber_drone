...
int main(){
    const char *input_dev = "/dev/input/by-id/usb-EdgeTX_Radiomaster_Pocket_Joystick_00000000001B-event-joystick";
    ...
    snprintf(uidev.name, UINPUT_MAX_NAME_SIZE, "Virtual Old Pocket Joystick");
    ...
    int abs_rudder_buttons[] = {BTN_0, BTN_1, BTN_2};
    int abs_ry_buttons[] = {BTN_3, BTN_4};
    int abs_rz_buttons[] = {BTN_5, BTN_6, BTN_7};
    int abs_thr_buttons[] = {BTN_8, BTN_9};
